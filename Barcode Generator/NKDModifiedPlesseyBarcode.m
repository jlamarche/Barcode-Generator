...
// -----------------------------------------------------------------------------------
{
    ...
    char 	*code = (char *)[[self content] cStringUsingEncoding:NSUTF8StringEncoding], *productString;
    NSNumber	*product;
    ...
    productString = (char *)[[product stringValue] cStringUsingEncoding:NSUTF8StringEncoding];
