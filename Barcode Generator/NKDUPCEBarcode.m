...
// -----------------------------------------------------------------------------------
{
    ...
    {
        NSString *barcodeString = [NSString stringWithFormat:@"%@%c", [self content], [self checkDigit]];
        [self setContent:[[self class] UPCAToUPCE:barcodeString]];
    }
...
// -----------------------------------------------------------------------------------
{
    ...
    contentString = (char *)[[self content] cStringUsingEncoding:NSUTF8StringEncoding];
...
// -----------------------------------------------------------------------------------
{
    char		*contentString = (char *)[[self content] cStringUsingEncoding:NSUTF8StringEncoding];
